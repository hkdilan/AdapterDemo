...
public class CustomArrayWithCustomObjectAdapter extends ArrayAdapter<CustomObject> {

	private Context mContext;
	private ArrayList<CustomObject> mValues;
	
	//constructor with context and values for adapter view(list)
	public CustomArrayWithCustomObjectAdapter(Context context, ArrayList<CustomObject> values) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		//set data to layout
		viewHolder.text.setText(mValues.get(position).getName());
